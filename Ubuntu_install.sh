...
sudo apt-get install i3 feh cmatrix tty-clock htop mpd lxappearance ranger chromium-browser gnome-icon-theme-full compton i3blocks libfftw3-dev libncursesw5-dev libpulse-dev pulseaudio xdotool -y
